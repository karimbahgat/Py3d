...
# FB36 - 20130829
"""
this time from http://code.activestate.com/recipes/578652-voxel-based-ray-tracing/
more info on voxel ray tracing, http://www.ign.com/boards/threads/so-could-the-x1s-secret-sauce-be-voxel-cone-ray-tracing.453362563/
apparently voxels are small volume cubes which makes up the whole scene and builds the geometries
"""
import math, time
...
def CreateScene():
    ...
    CreateMirrorSphere(imgx / 2.0, imgy / 2.0, imgz / 2, 150.0, (0, 255, 0), 0.05)
